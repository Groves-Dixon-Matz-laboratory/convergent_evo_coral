#---- CUTOFF SELECTION ----#
set.label = 'strict'
results.path = 'overlap_results/semi_strict'
...
bs.gene.pvalue.cutoff = 0.1     #unadjusted p-value the gene has to have for full branch site test to consider a flagged site passing
